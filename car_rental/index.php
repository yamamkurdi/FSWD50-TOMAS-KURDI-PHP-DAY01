...
<html>
<head>
<title>Car Rental Project - CodeFactory</title>
<!-- for-mobile-apps -->
...
<div class="header-w3l-agile">
		<div class="header_left">
			<ul>
				<li><a href="">Placeholder for LOGIN bar</li>
			</ul>
		</div>
...
<div class="services" id="service">
		<div class="container">
				...
				foreach( $cars as $value )
					{
				echo '<div class="col-md-4 myspace agileits_service_grid_btm_left">
					<div class="agileits_service_grid_btm_left1">
						<div class="agileits_service_grid_btm_left2">
							<h5>'. $value['brand'].'</h5>
							<p>Per day<span>$</span>'. $value['price'].'</p>
							<p>'. $value['model'].'</p>
...
<div class="w3ls_newsletter_social">
	...
	<div class="w3l_footer_agile">
			<p>© 2018 Car Rental. All Rights Reserved | Design by Mr. Robot - CodeFactory</a></p>
